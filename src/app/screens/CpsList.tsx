...
function CreateTemplateSheet({
  ...
  const exampleTopics = ['Audit Kebersihan', '5R Showroom (FY25)', 'Cek Fasilitas'];
                ...
                <div className="pt-4 space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Contoh: Audit kebersihan ruang tunggu dealer, evaluasi standar pelayanan front desk..."
                      rows={4}
